...
CREATE TABLE `suministra` (
  ...
  CONSTRAINT `suministra_ibfk_1` FOREIGN KEY (`cod_pieza`) REFERENCES `piezas` (`cod`),
  CONSTRAINT `suministra_ibfk_2` FOREIGN KEY (`id_prove`) REFERENCES `proveedores` (`id`)
...
INSERT INTO `suministra` VALUES (1,'2',50),(2,'3',100),(3,'4',500),(4,'5',530),(5,'1',520);
