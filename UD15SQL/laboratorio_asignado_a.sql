...
--
-- Host: 192.168.1.126    Database: laboratorio
-- ------------------------------------------------------
...
CREATE TABLE `asignado_a` (
  ...
  CONSTRAINT `asignado_a_ibfk_1` FOREIGN KEY (`dni_cien`) REFERENCES `cientificos` (`DNI`),
...
INSERT INTO `asignado_a` VALUES ('34567891','0001'),('09876543','0002'),('87654321','0003'),('98765432','0004'),('98765432','0005');
...
-- Dump completed on 2021-07-28 11:04:18
